  ...
  <Layout>
    ...
    <div className='page news'>
      ...
      <section className='new-news'>
        <h3 className='news-date'>воскресенье, 5 апреля 2020 год</h3>
        <p>Уважаемые читатели!</p>
        <p>В связи с коронавирусом выходные дни продлятся до 10 апреля включительно.</p>
        <p>С библиотекарем Фалалеевой Еленой Евгеньевной вы можете связаться ВКонтакте и Одноклассниках.</p>
        <p>Берегите себя и своих родственников! Оставайтеся дома!</p>
      </section>
      <section className='new-news'>
