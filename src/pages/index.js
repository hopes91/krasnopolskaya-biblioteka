  ...
  <Layout>
    ...
    <div className='page news'>
      ...
      <section>
        ...
        <img src={news27012020} alt='Краснопольская библиотека участвует в сетевой акции «ПоЧитатели Чехова» к 160-летию со дня рождения писателя' className='page-image' />
      </section>
      <section>
