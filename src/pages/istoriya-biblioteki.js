...
import insideTheLibraryOne from '../images/DSCN4651.jpg'
import insideTheLibraryTwo from '../images/SDC12945.jpg'
import outsideTheLibrary from '../images/DSCN1289.jpg'

const LibraryHistoryPage = () => (
  <Layout>
    <SEO title='История библиотеки' keywords={[`история библиотеки`, `краснопольская библиотека`, `краснополье`, `сунский район`, `суна`, `кировская область`]} />
    <div className='about-library library-history'>
      <OrnamentMain />
      <h2>История Краснопольской библиотеки</h2>
      ...
      <img src={insideTheLibraryOne} alt='Краснопольская библиотека изнутри' />
      <img src={insideTheLibraryTwo} alt='Краснопольская библиотека изнутри' />
