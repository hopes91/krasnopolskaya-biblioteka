...
const WorkSchedulePage = () => (
  <Layout>
    ...
    <div className='page page_about page_about_schedule'>
      ...
      <p className='page_about_schedule__days'><strong>Понедельник — четверг</strong></p>
      <p className='page_about_schedule_time'>13:00 — 16:30</p>
      <p className='page_about_schedule__days'><strong>Пятница</strong></p>
      <p className='page_about_schedule_time'>13:00 — 16:00</p>
      <p className='page_about_schedule__days'><strong>Суббота, воскресенье</strong></p>
      <p className='page_about_schedule_time'>выходные дни</p>
      <p className='page_about_schedule__days'><strong>Раз в месяц занятие семейного клуба «От всей души»</strong></p>
