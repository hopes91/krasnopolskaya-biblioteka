...
const PosterBiblionikPage = () => (
  <Layout>
    ...
    <div className='news-and-events poster-biblionik'>
      <OrnamentMain />
      <h2>Программа кружка «Библионик» на 2019 год</h2>
      ...
      {biblonikEvents.map((event, ind) => {
        ...
        return (
          <div key={posterDate}>
            ...
            {posterEvents.map(posterEvent => <p key={posterEvent} className='poster-events'>{posterEvent}</p>)}
          </div>
        )
      })}
    </div>
